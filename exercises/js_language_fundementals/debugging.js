...
function greet(...args) {
  ...
  for (let i = 0; i < names.length; i++) {
    const name = names[i];
    const greeting = randomGreeting(); // added invocation
...
function placeABet(guess) {
  ...
  }; // parentheses turns a declaration into a function expression with no variable assigned to it. It cannot be invoked. The function name is just a name thats scoped to the function expression
...
let energy = 100;
let currentPage = 1; // move this page outside the function
